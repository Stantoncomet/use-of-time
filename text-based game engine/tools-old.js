...
function preProcessCmd(c) {
    let pCmd = CMD.getPretty(); // Clear trailing spaces and make non-case sensitive
    printToBox(CMD.getDisplay(false)); // Print command to box
    CMD.clear(); // Clear user input
